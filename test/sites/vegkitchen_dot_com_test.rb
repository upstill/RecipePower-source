...
class VegkitchenDotComTest < ActiveSupport::TestCase
  include PTInterface
...
asparagus Asian\ rice\ noodles scallions sesame\ seeds } # All ingredients found on the page
    ...
    # @trimmers = ["div.wprm-recipe-image", "div.wprm-recipe-rating", "a.wprm-recipe-link", "h3.wprm-recipe-header"]
		@selector = "article.entry"
		@sample_url = 'http://www.vegkitchen.com/recipes/sesame-noodles-with-asparagus-tips/'
		@sample_title = 'Sesame Noodles with Asparagus Tips'
