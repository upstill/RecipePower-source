...
class SimonmajumdarDotComTest < ActiveSupport::TestCase
  include PTInterface

  # Set up the parser, trimmers, selectors for the woks_of_life site
  def setup
    @ingredients = %w{ Limes Ground\ Turmeric Ground\ Fenugreek\ Seed Garlic\ Cloves Fresh\ Ginger
      Red\ Chili\ Powder Salt Sugar Asafoetida Vegetable\ Oil Dried\ Red\ Chilies Curry\ Leaves
      Nigella\ Seeds Mustard\ Seeds Fenugreek\ Seeds
 } # All ingredients found on the page
    @units =  %w{ Tsp Inches Cup Tablespoons } # All units
    ...
    # Grammar mods, css_selector and trimmers that apply to recipes
		...
		@selector = "div[data-testid='mesh-container-content']"
		@sample_url = 'https://www.simonmajumdar.com/fiery-hot-lime-pickle'
...
=end
  ...
  test 'ingredient list' do
    # Unmatched '('
    html = '<li>1/4 Cup Sugar (this is optional, but I like the balance</li>'
    pt_apply :rp_ingline, ingredients: 'Sugar', units: 'Cup'
