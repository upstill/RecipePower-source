...
class ProportionalplateDotComTest < ActiveSupport::TestCase
  include PTInterface
  ...
  def setup
    ...
    # Grammar mods, css_selector and trimmers that apply to recipes
		@grammar_mods = {
			...
			:rp_instructions => {
				:in_css_match => "ul.wprm-recipe-instructions"
			}
		}
		@trimmers = ["div.wprm-container-float-right", "div.wprm-call-to-action"]
		@selector = "div.wprm-recipe-container"
		@sample_url = 'https://www.proportionalplate.com/sour-cherry-shrub-drinking-vinegar/'
		@sample_title = 'Sour Cherry Shrub'
