...
class ParserTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @unit_tags = %w{ can inch knob massive\ head ounce g ml kg tablespoon tablespoons tbsp T. teaspoon tsp. tsp cup head pound small small\ head clove cloves large }.
