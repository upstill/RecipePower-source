...
puts "Processing site names, etc."
sites = [
...
"http://www.spicyicecream.com.au",
"http://www.latimes.com",
"http://momofukufor2.com",
"http://www.kayahara.ca",
"http://homesicktexan.blogspot.co.nz",
"http://www.modernbeet.com",
...
"http://today.msnbc.msn.com/id/3041421/ns/today-foodwine/",
"http://www.foodandwine.com",
"http://www.japanesefoodreport.com",
"http://www.saveur.com",
"http://online.wsj.com",
"http://www.tasteofbeirut.com",
"http://www.umamimart.com",
...
"http://www.pbs.org",
"http://www.npr.org",
"http://www.sophisticatedgourmet.com",
...
"http://sourplum.wordpress.com",
"http://www.hungrycravings.com",
...
"http://www.thechefproject.com",
"http://events.nytimes.com",
"http://www.mariquita.com",
"http://japanesefoodreport.com",
...
"Esquire Food",
"Esquire Drinks",
"Georgia Pellegrini.com",
"Guardian UK Life and style",
"New York Magazine",
"recipe girl(tm)",
"Leite's Culinaria",
"Chocolate & Zucchini",
...
"Jamie Oliver",
"Ideas in Food",
"El nuevo rincon de los sabores",
"Epicurious",
"Allrecipes.com",
"Food Network",
"Serious Eats",
...
"Oprah.com",
"Lidia's Italy",
"Furious Eats, Cooks, and Travels",
"The New York Times",
"[ NO RECIPES ]",
...
sites.each_index { |i|
    ...
    puts "#{sitename} gets named \'#{name}' replacing \'#{ttlcut}'"
    if site = Site.find_by_home(sitename)
        puts "...has name \'#{site.name}' and replaces \'#{site.ttlcut}' "
        site.name = name
        site.ttlcut = ttlcut
        site.save
    else
