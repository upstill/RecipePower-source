class CreateEditions < ActiveRecord::Migration
  def change
    ...
    Edition.create "opening"=>"Without trying a hard sell, I'd like to invite you to my new project, the RecipePower newsletter. After years of work, the site is finally ready for prime time, and I want to use it myself. RecipePower is about wrangling the best recipes and food-related information from around the Web, and this newsletter is going to be a weekly jolt of inspiration from my kitchen to yours.\
