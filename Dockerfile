...
MAINTAINER Steve Upstill <steve@upstill.net>
...
RUN bundle exec rake RAILS_ENV=production DATABASE_URL=postgresql://upstill:sejdy2@127.0.0.1/cookmarks_production ACTION_CABLE_ALLOWED_REQUEST_ORIGINS=foo,bar SECRET_TOKEN=dummytoken assets:precompile
