# lifted from https://gist.github.com/tokenvolt/6599141
inputs = %w[
...
# direct from https://gist.github.com/tommarshall/6308327/0141a600a93a1711d4762a04dd0d85a3ee14041e
inputs = %w[
  CollectionSelectInput
  DateTimeInput
  FileInput
...
=end
=begin
# Use this setup block to configure all options available in SimpleForm (old).
SimpleForm.setup do |config|
  config.wrappers :bootstrap, :tag => 'div', :class => 'form-group', :error_class => 'error' do |b|
    b.use :html5
    b.use :placeholder
...
=end
=begin
# Original simple_form.rb initializer
# Use this setup block to configure all options available in SimpleForm.
SimpleForm.setup do |config|
