RP::Application.configure do
  ...
  config.public_file_server.enabled = true # config.serve_static_files = true
  ...
  config.assets.precompile += %w( jquery.js jquery2.js collection.css collection.js injector.css injector.js jquery.panelSnap.js panels.css feedback.css )
  ...
  config.action_mailer.default_url_options = { :protocol => :https, :host => 'www.recipepower.com' }
