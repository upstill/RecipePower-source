RP::Application.configure do
  ...
  config.public_file_server.enabled = false # config.serve_static_files = false
  ...
  config.assets.precompile += %w( jquery.js jquery2.js bootstrap_preface.css
        collection.css collection.js
        injector.css injector.js
        jquery.panelSnap.js panels.css feedback.css
   )
  ...
  config.action_mailer.default_url_options = { :protocol => :https, :host => 'staging.recipepower.com' }
