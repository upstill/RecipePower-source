...
gem "simple_form", "~> 4.0", ">= 4.0.0" # https://github.com/plataformatec/simple_form
# Decorators/View-Models for Rails Applications
gem 'draper', '~> 3.0', '>= 3.0.1' #, ~> 1.3'
# Easily and efficiently make your ActiveRecord models support hierarchies
gem 'closure_tree', '~> 6.6', '>= 6.6.0' # https://github.com/mceachen/closure_tree
...
gem 'activity_notification', '1.5.0', :path => 'vendor/gems/activity_notification-1.4.4'
...
gem 'premailer-rails' , '>= 1.10.2' # https://github.com/fphilipe/premailer-rails
...
gem 'rails-observers' , '>= 0.1.5' # https://github.com/rails/rails-observers
