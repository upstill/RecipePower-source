...
gem 'rack', '2.2.8.1'
gem 'bundler', '~> 2.1.4'
gem 'rails', '~> 7.0.8', '>= 7.0.8.1' # 5.0.7.2' #
gem 'rdoc', '>= 6.3.4.1'
...
gem 'activity_notification' , '>= 2.2.3' # , '1.4.4', :path => 'vendor/gems/activity_notification-1.4.4'
...
gem 'devise_invitable', '~> 2.0', '>= 2.0.9' # git: 'git://github.com/scambra/devise_invitable.git'
gem 'ruby-openid'
...
###### Essential Ruby libs
gem "rmagick", "~> 2.16.0"
gem "feedjira", "~> 2.0", ">= 2.0.0" #:git => 'git://github.com/pauldix/feedzirra.git'
gem 'nokogiri', '>= 1.15.6' # "~> 1.5.3"
gem 'truncato' , '>= 0.7.12' # ,  '0.7.8' # Truncates HTML strings, respecting tags https://github.com/jorgemanrubia/truncato
...
group :development do
  ...
  ## gem "json"
  gem 'rack-mini-profiler', '~> 1.0', '>= 1.0.0' # Subsequent versions require Ruby 2.3
  gem 'derailed'
