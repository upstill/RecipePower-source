...
gem "simple_form" , ">= 5.0.1" # , '~> 4.1.0' # https://github.com/plataformatec/simple_form
# Decorators/View-Models for Rails Applications
gem 'draper' , '>= 3.1.0' # , '~> 3.0' #, ~> 1.3'
...
gem 'activity_notification' , '>= 2.0.0' # , '1.4.4', :path => 'vendor/gems/activity_notification-1.4.4'

####### JQuery, Coffeescript and Bootstrap
gem 'jquery-rails', '~> 4.4.0' # '~> 4.2.0' # '~> 4.3.3' # ~> 4.0' # '2.2.1' to get jQuery 1.9.1
## gem 'jquery-rails-google-cdn'
gem 'jquery-ui-rails', '~> 3.0', '>= 3.0.1'
gem 'coffee-rails' , '>= 5.0.0' # , "~> 4.2"
gem 'uglifier', '>= 1.3.0'
## gem 'compass-rails'
...
gem 'devise', '~> 4.7', '>= 4.7.1' # auth, rails generate devise:install, rails generate devise MODEL
...
group :test do
  ...
  gem 'factory_bot_rails' , '>= 5.1.1' # 'factory_girl_rails', "~> 4.0"
  gem "mocha"
...
gem 'premailer-rails' , '>= 1.10.3' # https://github.com/fphilipe/premailer-rails
