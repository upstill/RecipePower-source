...
%Q{	    <br>
     ...
     def query_tabset
       s = <<BLOCK_END
      <h4 class="rcpquery_list_header" id="rcpquery_mylist">My Cookmarks</h4>
...
BLOCK_END
  ...
  # Set up the query-results page section for "Every Cookmark in the Whole Wide World"
  def query_masterset
      %Q{
          <h4  class="rcpquery_list_header" id="rcpquery_masterlist_header">Every Cookmark in the Whole Wide World (of RecipePower)</h4>
          <div class="rcpquery_list" id="rcpquery_master_list" ></div>
        }.html_safe
  end
