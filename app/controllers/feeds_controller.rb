...
class FeedsController < ApplicationController
  ...
  # GET /feeds.json
  def index
    seeker_result Feed, 'div.feed_list', clear_tags: true, all_feeds: permitted_to?(:approve, :feeds)
  end
  ...
  def query
    seeker_result Feed, 'div.feed_list', all_feeds: permitted_to?(:approve, :feeds)
  end
